...
namespace SistemaSolar {
	...
	/// Resumen de Jupiter
	/// </summary>
	public ref class Jupiter : public System::Windows::Forms::Form
	{
	public:
		Jupiter(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Jupiter::typeid));
			...
			this->buttonVolver->Click += gcnew System::EventHandler(this, &Jupiter::buttonVolver_Click);
			// 
			// Jupiter
			// 
