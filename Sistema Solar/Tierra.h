...
namespace SistemaSolar {
	...
	/// Resumen de Tierra
	/// </summary>
	public ref class Tierra : public System::Windows::Forms::Form
	{
	public:
		Tierra(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Tierra::typeid));
			...
			this->buttonVolver->Click += gcnew System::EventHandler(this, &Tierra::buttonVolver_Click);
			// 
			// Tierra
			// 
