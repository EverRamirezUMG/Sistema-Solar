...
namespace SistemaSolar {
	...
	/// Resumen de Saturno
	/// </summary>
	public ref class Saturno : public System::Windows::Forms::Form
	{
	public:
		Saturno(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Saturno::typeid));
			...
			this->buttonVolver->Click += gcnew System::EventHandler(this, &Saturno::buttonVolver_Click);
			// 
			// Saturno
			// 
